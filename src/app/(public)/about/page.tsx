  ...
  return (
    <main id="main-content">
      ...
      <section className="relative min-h-[80vh] overflow-hidden">
        <Image src="/c8adc763-a691-488d-ab1c-a2fdccda6380.jpg" alt="About Adventures Wheel" fill className="object-cover" sizes="100vw" priority />
        ...
        <div className="relative z-10 mx-auto flex min-h-[80vh] max-w-[1440px] flex-col justify-center px-6 pt-20 lg:px-12">
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            <motion.p variants={fadeIn} className="text-xs font-semibold uppercase tracking-[0.5em] text-white/70">About Us</motion.p>
