    ...
    <main id="main-content">
      ...
      <section className="relative min-h-[50vh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[50vh] max-w-[1440px] flex-col justify-center px-6 pt-20 lg:px-12">
          ...
          <h1 className="mt-4 max-w-3xl text-[clamp(3rem,7vw,6rem)] leading-[0.92] text-white font-normal" style={{ fontFamily: '"vaccine", serif' }}>
            Our Adventures
          </h1>
              ...
              >
                ...
                >
                  <div className="relative aspect-[4/3] overflow-hidden">
                    <Image src={trip.heroImage || '/placeholder.jpg'} alt={trip.title} fill className="object-cover transition-transform duration-700 group-hover:scale-110" sizes="33vw" />
                    {trip.badge && (
                  ...
                  <div className="flex flex-1 flex-col px-6 py-6 font-sans">
                    <h3 className="text-2xl font-normal tracking-tight leading-tight text-[#0f211c] transition-colors duration-300 group-hover:text-[#122822]" style={{ fontFamily: '"vaccine", serif' }}>
                      {trip.title}
                    </h3>
                    ...
                    <div className="mt-auto pt-6">
                      <div className="grid grid-cols-[1fr_auto] border-t-2 border-dotted border-[#0f211c]/20 pt-5">
                        <ul className="space-y-1.5 text-sm font-normal text-[#0f211c] pr-4" style={{ fontFamily: '"vaccine", serif' }}>
                        ...
                        <div className="relative flex flex-col justify-center pl-6 text-[#0f211c]">
                          ...
                          <div className="text-[12px] mb-1 text-[#0f211c] font-bold uppercase tracking-widest" style={{ fontFamily: '"vaccine", serif' }}>From :</div>
