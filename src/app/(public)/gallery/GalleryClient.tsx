...
export default function GalleryClient({ heroSlide }: { heroSlide?: any }) {
    ...
    <main id="main-content">
      ...
      <section className="relative min-h-[50vh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[50vh] max-w-[1440px] flex-col justify-center px-6 pt-20 lg:px-12">
          <p className="text-xs font-semibold uppercase tracking-[0.5em] text-white/70">{slide.subtitle}</p>
