                ...
                <div className="flex gap-4 md:gap-8 overflow-x-auto snap-x snap-mandatory pb-12 pt-8 hide-scrollbar items-center">
                    {galleryImages.map((img, idx) => (
                        ...
                        >
                            ...
                            {/* Corner accent */}
                            <div className="absolute top-4 right-4 bg-black/70 p-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none text-[#FAF9F6]">
                                <Instagram size={18} />
                            </div>
