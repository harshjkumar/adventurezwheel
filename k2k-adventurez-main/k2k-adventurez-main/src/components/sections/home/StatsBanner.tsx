...
function Counter({ target, suffix }: { target: number; suffix: string }) {
  ...
  return (
    <div ref={ref} className="font-sans text-5xl sm:text-6xl lg:text-7xl font-light tracking-tight text-white">
      {count}
  ...
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden">
      <div
        ...
        style={{ backgroundImage: "url(/images/trips/3.webp)", willChange: "auto" }}
      />
