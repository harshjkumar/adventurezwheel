...
import { IOSOptimizations } from "@/components/layout/IOSOptimizations";
...
export default async function RootLayout({
  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col font-sans bg-white text-charcoal w-full relative">
        <ScrollToTop />
        <IOSOptimizations />
        <Navbar trips={trips} />
